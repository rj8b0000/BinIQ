          ...
          <View style={{marginVertical: '3%', paddingHorizontal: '5%'}}>
            <View
              ...
              <Pressable
                ...
                nPress={() => navigation.navigate('CourseDetails')}>
                <Image
                  source={require('../../../assets/reseller_training.png')}
                  style={{width: wp(44), height: hp(13), borderRadius: 5}}
                />
                <View
                  style={{
                    margin: '6%',
                  ...
                  <View>
                    ...
                    <Text
                      ...
                      How to start a bin store Intro to reselling video
                    </Text>
                    <Text
                      style={{
                        fontFamily: 'Nunito-SemiBold',
