        ...
        <View style={styles.container}>
            ...
            <View style={{ height: hp(40), marginTop: '10%', marginHorizontal: '7.5%', justifyContent: 'space-between' }}>
                <View style={{ height: '23%' }}>
                    <Text style={{ fontFamily: 'Nunito-Bold', color: '#14BA9C', fontSize: wp(7) }}>Become a Bin IQ PRO Today!</Text>
                </View>
                <View style={{ height: '65%', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row' }}>
                        <GreenCheck size={30} />
                        <Text style={{ fontFamily: 'DMSans-SemiBold', color: '#64748B', fontSize: wp(4.7) }}>{'  '}Advanced Library Access</Text>
                    </View>
                    <View style={{ flexDirection: 'row' }}>
                        <GreenCheck size={30} />
                        <Text style={{ fontFamily: 'DMSans-SemiBold', color: '#64748B', fontSize: wp(4.7) }}>{'  '}Inventory Management Tools</Text>
                    </View>
                    <View style={{ flexDirection: 'row' }}>
                        <GreenCheck size={30} />
                        <Text style={{ fontFamily: 'DMSans-SemiBold', color: '#64748B', fontSize: wp(4.7) }}>{'  '}Educational Resources</Text>
                    </View>
                    <View style={{ flexDirection: 'row' }}>
                        <GreenCheck size={30} />
                        <Text style={{ fontFamily: 'DMSans-SemiBold', color: '#64748B', fontSize: wp(4.7) }}>{'  '}Customer Support</Text>
                    </View>
                    <View style={{ flexDirection: 'row' }}>
                        <GreenCheck size={30} />
                        <Text style={{ fontFamily: 'DMSans-SemiBold', color: '#64748B', fontSize: wp(4.7) }}>{'  '}Secure Scans</Text>
                    </View>
                    <View style={{ flexDirection: 'row' }}>
                        <GreenCheck size={30} />
                        <Text style={{ fontFamily: 'DMSans-SemiBold', color: '#64748B', fontSize: wp(4.7) }}>{'  '}Storage for Scanned items</Text>
                    </View>
                </View>
            </View>
            <View style={{ position: 'absolute', height: hp(33), bottom: 0, width: '100%', borderTopLeftRadius: 10, borderTopRightRadius: 10, backgroundColor: '#F1F5F9' }}>
                ...
                <View style={{ width: '90%', height: '42%', flexDirection: 'row', alignSelf: 'center', marginVertical: '2%' }}>
                    ...
                    <View style={{ width: '33.5%', height: '100%', padding: '1%' }}>
                        <View style={{ width: '100%', height: '100%', borderWidth: 2, borderColor: '#14BA9C', borderRadius: 8, backgroundColor: '#fff', justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontFamily: 'Nunito-Bold', color: '#000', fontSize: hp(2.5) }}>Tier 2</Text>
                            <Text style={{ fontFamily: 'Nunito-SemiBold', color: '#130160', fontSize: hp(2.2) }}>$59.97/{'\n'}month</Text>
                        </View>
                    </View>
                    <View style={{ width: '33.5%', height: '100%', padding: '1%' }}>
                        <View style={{ width: '100%', height: '100%', borderWidth: 1, borderColor: '#14BA9C', borderRadius: 8, backgroundColor: '#fff', justifyContent: 'center', alignItems: 'center' }}>
